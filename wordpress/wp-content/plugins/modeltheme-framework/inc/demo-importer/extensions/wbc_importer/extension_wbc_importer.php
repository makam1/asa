...
if ( !function_exists( 'wbc_extended_example' ) ) {
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        ...
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                ...
                'Construction'  => 'contruction_slider.zip', //Set slider zip name
                'Handmade'      => 'handmade_slider.zip', //Set slider zip name
            );
        ...
        */
        // If it's demo1 - demo6
        $wbc_menu_array = array( 'Fashion', 'Flowers', 'Foods', 'Furniture', 'Wines', 'Music', 'Construction', 'Handmade' );
        ...
        */
        ...
        $wbc_home_pages = array(
            'Christmas'  => 'Homepage Christmas',
            'Fashion'   => 'Homepage Fashion',
            'Flowers'   => 'Homepage Flowers',
            'Foods'     => 'Homepage Food',
            'Furniture' => 'Shop Homepage',
            'Wines'     => 'Homepage Wines',
            'Music'     => 'Homepage Music',
            'Construction'     => 'Homepage Construction',
            'Handmade'     => 'Homepage Handmade',
        );
